...
- The second item should contain the percentage of bonus the employee is to receive.
- The third item should be the adjusted annual compensation (base annual + bonus)
...
You may abstract out the bonus calculation into a second function if you like, but this is not mandatory.
